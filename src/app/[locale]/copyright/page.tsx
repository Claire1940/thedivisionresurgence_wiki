...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Copyright Notice - The Division Resurgence Wiki',
    description: 'Copyright and intellectual property information for The Division Resurgence Wiki. Learn about content ownership, fair use, DMCA policy, and how to report copyright infringement.',
    keywords: [
      'copyright notice',
      'The Division Resurgence Wiki copyright',
      'DMCA policy',
    ...
    openGraph: {
      ...
      title: 'Copyright Notice - The Division Resurgence Wiki',
      description: 'Copyright and intellectual property information for The Division Resurgence Wiki.',
      images: [
        {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              © 2025-2026 The Division Resurgence Wiki. All rights reserved.
            </p>
            <p>
              Unless otherwise noted, all original content on this website, including but not limited to text,
              graphics, logos, guides, articles, and compilations, is the property of The Division Resurgence Wiki and is
              protected by international copyright laws.
            </p>

            <h3>1.2 Game Assets and Trademarks</h3>
            <p>
              The Division Resurgence Wiki is an <strong>unofficial fan-made website</strong> and is NOT affiliated with,
              endorsed by, or associated with:
            </p>
            <ul>
              <li><strong>Ubisoft</strong> - Publisher and developer of The Division Resurgence</li>
              <li><strong>The Division Resurgence Team</strong> - Creators of The Division Resurgence game</li>
            </ul>
            <p>
            ...
            <ul>
              ...
              <li><strong>The Division Resurgence</strong> - Trademark of the game developers</li>
              <li><strong>The Division Resurgence Wiki</strong> - Our own branding (not affiliated with the game)</li>
            </ul>
            <p>
              ...
              affiliation with The Division Resurgence Wiki.
            </p>
            ...
            <p>
              ...
              The Division Resurgence Wiki<br />
              Email: <a href="mailto:dmca@thedivisionresurgence.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@thedivisionresurgence.wiki</a>
            </p>
            <p>
            ...
            <ul>
              <li>Provide clear attribution to "The Division Resurgence Wiki"</li>
              <li>Include a link back to the original page (if digital)</li>
              <li>Do not imply endorsement or affiliation</li>
            </ul>
            <p>
              Example attribution: <em>"Source: The Division Resurgence Wiki (thedivisionresurgence.wiki)"</em>
            </p>
            ...
            <p>
              <strong>General Inquiries:</strong> <a href="mailto:copyright@thedivisionresurgence.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">copyright@thedivisionresurgence.wiki</a><br />
              <strong>DMCA Notices:</strong> <a href="mailto:dmca@thedivisionresurgence.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@thedivisionresurgence.wiki</a>
            </p>
            <p>
