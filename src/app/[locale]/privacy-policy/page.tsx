...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Privacy Policy - The Division Resurgence Wiki',
    description: 'The Division Resurgence Wiki Privacy Policy. Learn how we collect, use, and protect your data when you use our mobile game resource platform. Your privacy matters to us.',
    keywords: [
      'privacy policy',
      'The Division Resurgence Wiki privacy',
      'data protection',
      'user privacy',
      'GDPR compliance',
    ],
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              The Division Resurgence Wiki ("we", "our", or "us") collects minimal information to provide and improve our services.
            ...
            <p>
              Our website may contain links to external websites, including Ubisoft, Google Play, App Store, Discord, and social media platforms.
            ...
            <h2>11. Disclaimer</h2>
            <p>
              The Division Resurgence Wiki is an unofficial fan-made website and is not affiliated with, endorsed by, or associated
              with Ubisoft or the developers of The Division Resurgence. All game content, trademarks, and assets are
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:privacy@thedivisionresurgence.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">privacy@thedivisionresurgence.wiki</a>
            </p>
            <p>
